"""
v3/signals/fii_dii_classifier.py
==================================
FII/DII Activity Classifier — v2
...
Cache:
  v3/cache/fii_dii_thresholds.json
...
log = logging.getLogger('v3.fii_dii')
...
THRESHOLDS_FILE = ROOT / 'v3' / 'cache' / 'fii_dii_thresholds.json'

STRIKE_STEP   = 50
ATM_BAND      = 200    # ±200 pts = 4 strikes for ATM build rate
OTM_MIN       = 300    # OTM price shift starts at +300 from ATM
OTM_MAX       = 800
